...
<html>
	...
	<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8">
				<h1>&nbsp;关于我&nbsp;<small>&nbsp;&nbsp;&nbsp;只能用三个字概括自己---我真帅</small></h1>
				<hr class="My_hr1"/>
				...
				<div class="row MY_divbordertop"  >
					<div class="MY_divpadding" id="div01">
						...
						<br/>
						<c:if test="${user.type==1 }">
							<button id="button01" class="btn btn-success">修改</button>
						</c:if>
					...
					<c:if test="${user.type==1 }">
						<div class="MY_divpadding" id="div02">
							...
							<form  method="post" action="MyinfoController?action=updatemyinfo">
								...
								<div class="form-group">
									<label class="MY_fontSize4"><span class="glyphicon glyphicon-info-sign" aria-hidden="true">&nbsp;个人简介&nbsp;</label>
									 <textarea  class="MY_textarea"  id="exampleInputFile" cols="100" rows="3" name="description" >${me.description }</textarea>	
								</div>
