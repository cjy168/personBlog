					...
					<form action="AddNewArticle" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label class="MY_fontSize4">&nbsp;主体内容&nbsp;</label>
								 <textarea  class="MY_textarea"  id="exampleInputFile" cols="100" rows="25" name="body"></textarea>	
							</div>
				...
				<c:if test="${edit eq 0}">
					<div class="row MY_divbordertop">
						<form action="EditArticle" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									<label class="MY_fontSize4">&nbsp;主体内容&nbsp;</label>
									 <textarea  class="MY_textarea"  id="exampleInputFile" cols="100" rows="25" name="body">${article.body}</textarea>	
								</div>
